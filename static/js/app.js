    ...
    if (dataElement) {
        try {
            window.dashboardData = {
                trafficDates: JSON.parse(dataElement.dataset.trafficDates || '[]'),
                trafficData: JSON.parse(dataElement.dataset.trafficData || '{}'),
                deviceData: JSON.parse(dataElement.dataset.deviceData || '[]')
            };
